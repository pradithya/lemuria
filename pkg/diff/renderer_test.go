...
func TestRenderPlan(t *testing.T) {
	...
	parts := renderer.RenderPlan(results, 42)
...
func TestRenderNewAndDeletedApps(t *testing.T) {
	...
	t.Run("renders new application", func(t *testing.T) {
		...
		output := strings.Join(renderer.RenderPlan(results, 42), "")
...
func TestRenderPlanGrouping(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			output := strings.Join(renderer.RenderPlan(tt.results, 1), "")
...
func TestRenderPlanStandaloneBeforeGroups(t *testing.T) {
	...
	output := strings.Join(renderer.RenderPlan(results, 1), "")
